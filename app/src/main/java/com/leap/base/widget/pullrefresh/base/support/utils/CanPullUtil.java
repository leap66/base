package com.leap.base.widget.pullrefresh.base.support.utils;
...
import com.leap.base.widget.pullrefresh.base.support.impl.Pullable;
...
public class CanPullUtil {
  ...
  private static class AbsListViewCanPull implements Pullable {
    ...
    public boolean isGetBottom() {
      ...
      if (count == 0) {
        ...
        if (view != null
            && view.getBottom() <= absListView.getMeasuredHeight() - absListView.getPaddingBottom())
          return true;
      }
      return false;
    }
  ...
  private static class ScrollViewCanPull implements Pullable {
    ...
    public boolean isGetBottom() {
      ...
      if (scrollView
          .getScrollY() >= (scrollView.getChildAt(0).getHeight() - scrollView.getMeasuredHeight()))
        return true;
      else
        return false;
    }
